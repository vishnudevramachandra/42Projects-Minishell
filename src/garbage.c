...
/*   Updated: 2025/09/21 16:35:22 by swied            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* goes through the list and frees every pointer via tmp
...
/* creates new_node which ptr gets set to input +
new_node->next gets set to NULL */
...
/* If there is no node before it gets the head and tail |
else the node gets the next one in the list */
